...
class Order(models.Model):
    ...
    customer = models.ForeignKey('user.User', models.SET_NULL, related_name='customer_order', null=True)
    ...
    status = models.CharField(max_length=100, choices=CHOICES, default='N', null=True, blank=True)
...
class OrderProduct(models.Model):
    ...
    quantity = models.PositiveSmallIntegerField('Количество товара', default=1, null=True) 
